            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, type, row, meta) {
                        console.log()
                        return '<a class="me-2 btn btn-sm rounded-0 py-0 edit_data " href="javascript:void(0)" data-id="' + (row.id) + '"><span class="fa fa-pencil "></span></a><a class="btn btn-sm rounded-0 py-0 delete_data btn-danger" href="javascript:void(0)" data-id="' + (row.id) + '"><span class="fa fa-trash "></span></a>';
                    }
                }
            ],
